...
リモートワークにおける課題として、部下の業務状況や成果を評価できない、セキュリティ上のリスクがある、といったアンケート結果があります。セキュリティの問題については、仕組みづくりで何とかなる側面もあるでしょう。一方で、勤務管理や成果の把握、仕事の内容の割り振りや評価については一朝一夕でできるものではありません。これは、部下側だけの問題ではなく、上司側の問題でもあります。
