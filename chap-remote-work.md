...
こういったケースでは、モニターアームを使ってモニターを釣る手がありますね。今、一般的に流通している液晶などの薄型モニターはほとんどがVESA規格に対応しており、ネジでモニターアームにマウントできるようになっています。（液晶テレビもほぼほぼマウント穴がついていて同様にマウントできます。）

モニターアームをつかってモニターを釣る事で、メインモニターの横にサブモニターを本来だとありえない配置で増設することができますので、例えばSlackなどのコミュニケーションツールをそちらに表示として逃しておくなどするだけでも、大分作業効率が上がるはずですよ。
