...
イヤフォンマイクでもただし、お使いのPCのがマイク入力に対応しているかという確認は必要です。普通のイヤフォンは３極（L、R、GND)ですが、ヘッドセットは４極（L、R、Mic、GND)です。PCによっては前面端子は３極なんてのがあるかもしれません。音拾えないなあ・・・と思ったら、そういう観点で確認してみてください。
...
細すぎるといちいちストレスが溜まります。ADSLやCATVなどの細い回線を使っている人は、光に変えて良いでしょう。もちろん十分な速度が出ているなら結構ですが。

光に切り替えるとしても、工事までに３週間からそれ以上かかりますし、月額の費用も一般にはUPするでしょう。この状況ですから、工事が混雑している可能性もありますが。

なお、光だから一概に高速であるということも言えません。実際には回線ガチャであり、思ったほど速度が出ないとかは十分にありえます。また一定の太さの回線を複数人で共有するマンションタイプのような場合、特にタワマンのように人数が多いと確保できる帯域が実質的に細くなることが考えられます。そういうこともあるかもしれないということを一応念頭に置いておくと良いでしょう。それでもADSLやCATVよりは高速であることを期待したいですが。

最悪はキャリアを変えるなども必要になるかもしれません。とはいえ回線の乗り換えは大変ですから、祈り、善業を積むしかないかもしれませんが・・・
