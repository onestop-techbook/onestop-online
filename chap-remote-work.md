...
![“SynologyのNAS“](chap-remote-work/SynologyNAS.png?scale=0.7)

なお、自宅ではQNAPのNASを使っていますが、ほぼほぼ同様の機能がこちらにもあるようです。
（QNAPのほうがホームユースに多少寄っているようで、デフォルト設定だと電源落とす時に「Shuting down!」とか流暢な英語でいきなり鳴き出します。）
